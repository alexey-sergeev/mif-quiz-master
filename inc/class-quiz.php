...
class mif_qm_core  {
    ...
    function parse_question( $text ) 
    {
        ...
        foreach ( $arr as $item ) {
            ...
            if ( $answers_flag ) {
                ...
                // Собираем сам вопрос (фоормулировку задания)
    ...
    //
    // Производит разбор данных ответов "как есть"
    //
    ...
    private function get_questions_raw( $text )
    {
        ...
        foreach ( $arr as $item ) {
            ...
            //
            // Здесь можно пробрасывать комментарии и пустые строки
            //
            // if ( строка нам не интересна ) continue;
            //
